 ...
 *
 * ГРАНИЦА: это про `.md` (каталог). Блог на `.mdx` изолирован
 * (`mdx({ extendMarkdownConfig: false })`) и сюда НЕ входит: rehype ходит по
 * HAST и MDX/JSX не нейтрализует — у той трубы своя защита и своя задача.
 */
